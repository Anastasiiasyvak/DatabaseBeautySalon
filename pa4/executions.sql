...
CALL employee_details_by_id_sproc(1);
...
CALL total_quantity_and_avg_cost_sproc(@total_quantity, @avg_cost);
...
CALL update_quantity_and_avg_cost_sproc(@avg_cost, 3, 10);
...
CALL update_position_and_avg_salary_sproc(@avg_salary, 2, 'Administrator');
